...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      setErrorMsg(err.customMessage || err.response?.data?.title || 'بيانات الدخول غير صحيحة. يرجى المحاولة مرة أخرى.');
    }
  };

  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-50/50 p-4 sm:p-8">
      <div className="flex w-full lg:max-w-[60%] xl:max-w-[55%] min-h-[80vh] bg-[var(--surface)] rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-200/80 overflow-hidden" dir="rtl">
